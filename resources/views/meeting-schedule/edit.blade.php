                ...
                <div class="p-5 text-gray-900 sm:p-7">
                    <form method="POST" action="{{ route('meeting-schedule.update', $meetingSchedule) }}" class="space-y-6">
                        ...
                        <div class="meeting-form-actions">
                            <a href="{{ route('meeting-schedule.show', $meetingSchedule) }}" class="action-button-secondary w-full sm:w-auto">Cancel</a>
                            <button type="submit" class="action-button w-full sm:w-auto">Update Meeting</button>
                        </div>
                    </form>
        </div>
    </div>
